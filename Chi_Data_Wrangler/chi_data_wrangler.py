#pull in all of te functions required by the script
...
OUTFILE_SUPPRESSED_TRIPS = 'D:/TNC-Demand-Model/Inputs/Chicago Ride-Hailing/Suppressed Trips.csv'
AGG_SUPPRESSED_TRIPS = {'SUP_PRIVATE_TRIPS':'sum', 'SUP_SHARED_TRIPS':'sum', 'Pickup Community Area':'first', 'Dropoff Community Area':'first','Trip Seconds':'mean','Trip Miles':'mean', 'Fare':'mean', 'Tip':'mean', 'Additional Charges':'mean', 'Trip Total':'mean','Trips Pooled':'sum'}
...
AGG_FORMAT_CHI_RH = { 'Trip Seconds':'mean','Trip Miles':'mean', 'Fare':'mean', 'Tip':'mean', 'Additional Charges':'mean', 'Trip Total':'mean', 'TRIPS':'sum', 'Trips Pooled':'sum','TRAVEL_TIME_MINUTES':'mean','SPEED':'mean'}
OUTFILE_RAW_CHI_RH = 'D:/TNC-Demand-Model/Inputs/Chicago Ride-Hailing/Raw_Trip_Records_No_Suppressed.csv'
OUTFILE_NO_SUPPRESSED_PRIVATE_CHI_RH = 'D:/TNC-Demand-Model/Inputs/Chicago Ride-Hailing/Monthly_Trip_Records_No_Suppressed_Private.csv'
OUTFILE_NO_SUPPRESSED_SHARED_CHI_RH = 'D:/TNC-Demand-Model/Inputs/Chicago Ride-Hailing/Monthly_Trip_Records_No_Suppressed_Shared.csv'

OUTFILE_CHI_RH = 'D:/TNC-Demand-Model/Outputs/Monthly_Ridehail_Trips.csv' 
...
#Step 10 Constants
#uses the same output folder path constant as step 6
DROP_COLS = ['ORIGIN','DESTINATION','MONTH']
...
if __name__ == "__main__":
    ...
    sup_trips = pd.read_csv(OUTFILE_SUPPRESSED_TRIPS)
    visualize_suppressed_trips(sup_trips, TRACTS_SHAPEFILE, TRACTS_CENTROIDS_FILE_PATH, OUTFILE_SUPPRESSED_TRIPS_MAP)
    print('STEP 4 IS COMPLETE!')
    
    print('STEP 5: FORMATTING MONTHLY AVERAGE WEEKDAY CHICAGO RH DATA!')
    #format_chi_rh_data(TODS, YEARS, AGG_FORMAT_CHI_RH, H5_PATH, OUTFILE_SUPPRESSED_TRIPS, OUTFILE_EMPTY_OD_MATRIX, OUTFILE_RAW_CHI_RH, OUTFILE_NO_SUPPRESSED_PRIVATE_CHI_RH, OUTFILE_NO_SUPPRESSED_SHARED_CHI_RH, OUTFILE_CHI_RH)
    ...
    #est = daily_agg(ESTIMATION_FILE_FOLDER_PATH)
